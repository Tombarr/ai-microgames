...
We embrace a **"Digital Marker / Pop Art"** aesthetic (reminiscent of _WarioWare DIY_ or
_Scribblenauts_).

- **Why?** The thick outlines and flat colors effectively hide AI "hallucinations." If a line is
  wobbly, it looks like a stylistic choice (a doodle) rather than a glitch.
...
> **"vector art style, thick distinct black outlines, flat vibrant colors, no gradients, white
> background, sticker art, minimal details, 2D game asset"**
...
- **Post-Process**: All AI output must go through a **Background Removal** step (e.g., `rembg`) to
  turn the "white background" into transparency before being used as a sprite.
