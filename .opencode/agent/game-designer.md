...
- **Constraints:** Ensure mechanics are simple enough for rapid implementation (e.g., "tap to jump," "drag to catch"). Games should have a narrative arc that can be completed within the 5-10 second timeframe.
